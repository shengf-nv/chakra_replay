    ...
    if node.name == "HybridEPBuffer::update_buffer":
        ...
        def dispatch(*args):
            return hybrid_ep_buffer.dispatch(
                ...
                # num_dispatched_tokens_tensor is on the CPU pinned memory, Chakra does not capture this information, 
                # so we need to pin it to the GPU. Same for dispatch_with_permute and combine_with_unpermute.
